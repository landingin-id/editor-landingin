...
class Base {
	...
	function init() {
		...
		*/
		...
		if (\Vvveb\isEditor()) {
			$this->view->errors[]  = 'Form isian gagal terkirim';
			$this->view->success[] = 'Form isian telah berhasil terkirim';
			$this->view->info[]    = 'Form isian telah berhasil terkirim';
			$this->view->message[] = 'Form isian telah berhasil terkirim';
		}
	}
