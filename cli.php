...
#create page
php cli.php admin module=content/post action=save post_content[1][language_id]=1 post_content[1][name]=Buku Baru post_content[1][slug]=buku-baru post_content[1][content]=<h3>Tes buku baru</h3> site[]=1 status=publish type="page"
