...
class RecentCommentsComponent extends ServerComponent {
	constructor() {
		super();

		this.name = "Recent Comments";
		this.attributes = ["data-v-component-recent-comments"],
...
let recentCommentsComponent = new RecentCommentsComponent;
