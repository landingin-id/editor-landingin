...
Vvveb.ComponentsGroup['Bootstrap 5'] =
    ["html/container", "html/gridrow", "html/btn", "html/btn-link", "html/buttongroup", "html/alert", "html/card", "html/listgroup", "html/badge", "html/navbar", "html/pagination"];


Vvveb.Components.extend("_base", "html/container", {
    classes: ["container", "container-fluid"],
    image: "icons/container.png",
    html: '<div class="container" style="min-height:150px;"></div>',
    name: "Container",
    properties: [
        {
            name: "Type",
...
Vvveb.Components.extend("html/link", "html/btn", {
    ...
    html: '<a class="btn btn-default">Primary</a>',
    properties: [{
        name: "Background",
        key: "background",
        htmlAttr: "class",
...
Vvveb.Components.extend("_base", "html/badge", {
    ...
    name: "Badge",
    html: '<span class="badge bg-warning" style="color:#fff">Primary badge</span>',
    properties: [{
        name: "Color",
        key: "color",
        htmlAttr: "class",
...
Vvveb.Components.extend("_base", "html/gridrow", {
    name: "Grid Row",
    image: "icons/grid_row.png",
    classes: ["row"],
    html: '<section title="three columns" class="py-4"><div class="container"><div class="row"><div class="col-lg-4"></div><div class="col-lg-4"></div><div class="col-lg-4"></div></div></div></div>',
    children: [{
    ...
    properties: [{
        ...
        onChange: function (node) {
            node.append(generateElements('<div class="col-3"></div>')[0]);
